---
title: Ultramature
TLDR: Pro-Aging perfume, bottling the joy and vigor of best agers
tags: 
  - casestudy
time: Winterterm 22/23
field: ["perfume", "branding", "3D" ]
status: Read Now
layout: case_study.njk
for:  Das Parfum by Stefan Scheer
---

# tldr:
- The sense of smell serves as a subtle marker for identity, which is used to market scents with fantasies of social capital and power, be it beauty, youth, femininity/masculinity or uniqueness.
- Meanwhile, aging is is considered socially undesirable, especially for women and yet inevitable. Research found that a positive perspective on aging can have a positive influence on individual development over time.
- During this seminar, a pro-aging perfume was mixed, combining a warm, nostalgic feel with a clean and calm design approach. The 3D renderings were done in Blender
...
<aside> <a href="https://www.statista.com/statistics/509679/value-of-the-global-anti-aging-market/"> Value on the global anti aging market, Statista 2026-03-08</a>  </aside>
...
<aside> <a href=https://socialecology.uci.edu/news/aging-brings-happiness > Susan Charles on Happiness in older adults,  2026-03-08</a>  </aside>
...
<aside> <a href=[https://socialecology.uci.edu/news/aging-brings-happiness](https://ysph.yale.edu/news-article/yale-study-challenges-notion-that-aging-means-decline-finds-many-older-adults-improve-over-time/) > Yale study challenges notion that aging means decline, finds many older adults improve over time,  2026-03-08</a> </aside>
...
{% image "../_assets/img/26_Ultramature_Logo.png", "Wordmark 'Ultramature', modified Neue Kabel by Mac Schütz"%} 
{% image "../_assets/img/26_Ultramature_Packaging.png", "Braided Perfume Bottle in Front of a container" %} 

## Branding
For the perfume brand, inspiration was drawn from the middle to later part of the 20th century: Combining plastic scoubidou bands with warm, muted colours bleached out by long term light exposure. The name ultramature, a euphemism for aging, is set in a modified version of Mac Schütz’s _Neue Kabel_ (Monotype) - the combined letters serve as reference to neat, cursive writing and to the wickerwork used in the bottle design.
...
<div class="gallery">
<div> {% image "../_assets/img/26_Ultramature_Clayrender.png", "White Clay Render of a braided perfume bottle"  %} </div>
<div>
{% image "../_assets/img/26_Ultramature_Stage_Photo.png", "Braided Perfume Bottle in a bathroom with green tiled walls and golden hour lighting" %} </div> 
</div>
...
{% image "../_assets/img/26_Ultramature_Duftrichtung.png", "Scent Pyramid for the Perfume. Notes are woody, spicy, gourmand and flowery. It includes notes of honey, sandelwood, wax, lilly of the valley, vanilla, ISO-E SUper, Musk, Vanilla and Oud", "Ultramature, through the (hypothetical) eyes of the parfumo community" %} 